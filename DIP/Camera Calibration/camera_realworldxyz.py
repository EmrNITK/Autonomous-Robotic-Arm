...
class camera_realtimeXYZ:
    ...
    def __init__(self):
        ...
        self.cam_mtx=np.loadtxt(savedir+'camera_matrix.txt')
        self.dist=np.loadtxt(savedir+'distortion_coefficients.txt')
        self.newcam_mtx=np.loadtxt(savedir+'new_camera_matrix.txt')
